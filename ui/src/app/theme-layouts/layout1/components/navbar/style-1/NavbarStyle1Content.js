  ...
  return (
    <Root className={clsx('flex flex-auto flex-col overflow-hidden h-full', props.className)}>
      ...
      >
        ...
        <div className="flex flex-0 items-center justify-center py-48 opacity-50">
          <img className="w-full max-w-256" src="/assets/images/logo/turtles.svg" alt="footer logo" />
        </div>
      </StyledContent>
    </Root>
  );
